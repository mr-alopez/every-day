/* The only bundled file in the project.
   ...
   from plain script-tag JS. This exposes the one plugin we need on window,
   which lets index.html stay dependency-free and unbundled.
...
window.EveryDayNative = { LocalNotifications, Capacitor };
